	...
	<div class="p-6">
		...
		<div class="mb-4 flex space-x-4">
			<button
				onclick={connect}
				disabled={connectionState === 'connecting' || connectionState === 'syncing'}
				class="cursor-pointer rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
			>
